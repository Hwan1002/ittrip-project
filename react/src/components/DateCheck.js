    ...
    return (
        <div className="tripPlan_content">
            <div className="tripTile">
                <label>
                    여행 제목:
                    <input type="text" name="tripTitle" value={tripTitle} onChange={(e) =>{e.preventDefault(); setTripTitle(e.target.value)}}/>
                </label>
            </div>
            <div className="tripDates">
                <div className="dateContents">
                    ...
                    <DatePicker
                        ...
                        minDate={new Date()}
                        maxDate={tripDates.startDate
                            ? addDays(tripDates.startDate, 9)
                            : null}
