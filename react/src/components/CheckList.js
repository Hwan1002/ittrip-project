...
function CheckList2() {
  ...
  const { userInfo, setUserData } = useContext(ProjectContext);
  ...
  return (
    <div className='checklistAll'>
      ...
      <div className='checkInput'>
        <input type="text" autocomplete="off" value={input} onChange={(e) => setInput(e.target.value)} placeholder="체크 해야할 것이 있나요?"/>
